...
public class ProductEdmProvider extends CsdlAbstractEdmProvider {
    public static final String NAMESPACE = "CRM.Products";
    public static final String CONTAINER_NAME = "ProductsContainer";
    ...
    public CsdlEntityType getEntityType(FullQualifiedName entityTypeName) {
        if (ET_FQN.equals(entityTypeName)) {
            List<CsdlProperty> props = Arrays.asList(
                    ...
                    new CsdlProperty().setName("price").setType(Double.getFullQualifiedName())
            );
