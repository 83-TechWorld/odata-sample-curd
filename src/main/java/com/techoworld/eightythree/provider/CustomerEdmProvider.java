...
import static org.apache.olingo.commons.api.edm.EdmPrimitiveTypeKind.Int64;

public class CustomerEdmProvider extends CsdlAbstractEdmProvider {
    public static final String NAMESPACE = "CRM.Customers";
    public static final String CONTAINER_NAME = "CustomersContainer";
    public static final FullQualifiedName CONTAINER = new FullQualifiedName(NAMESPACE, CONTAINER_NAME);

    public static final String ET_NAME = "Customer";
    public static final FullQualifiedName ET_FQN = new FullQualifiedName(NAMESPACE, ET_NAME);
    public static final String ES_NAME = "Customers";
    ...
    public CsdlEntityType getEntityType(FullQualifiedName entityTypeName) {
        if (ET_FQN.equals(entityTypeName)) {
            List<CsdlProperty> props = Arrays.asList(
                    ...
                    new CsdlProperty().setName("name").setType(String.getFullQualifiedName()),
                    new CsdlProperty().setName("email").setType(String.getFullQualifiedName())
            );
